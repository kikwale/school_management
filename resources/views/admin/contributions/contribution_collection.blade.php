    ...
    <div class="inner">
        ...
        <div class="row">
          ...
          <div class="col-lg-9 col-md-9">
            <form role="form" method="post" action="adminGetClassContribution" enctype="multipart/form-data">
                @csrf
                <div class="col-md-3">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tr class="odd gradeX">
                               ...
                               <td>{{ $value->fname	 }}</td>
                                ...
                                <td class="center">
                                    ...
                                    &nbsp; <a href="admin-view-contribution-payments?id={{ $value->id }}"><i class="icon-eye-open text-primary"></i>view</a>
                                </td>
                            </tr>
                            ...
                            <div class="modal fade" id="fee_payment{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    ...
                                    <form role="form" method="post" action="admin-save-contribution-payment" enctype="multipart/form-data">
                                        @csrf
                            ...
                            <div class="modal fade" id="delete{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                    <form role="form" method="post" action="admin-edit-contribution-payment" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
