    ...
    <div class="inner">
        ...
        <div class="row">
          ...
          <div class="col-lg-9 col-md-9">
            <form role="form" method="post" action="adminGetClassFee" enctype="multipart/form-data">
                @csrf
                <div class="col-md-3">
                            ...
                            <tr class="odd gradeX">
                               ...
                               <td>{{ $value->fname	 }}</td>
                                ...
                                <td class="center">
                                    ...
                                    &nbsp; <a href="admin-view-fee-payments?id={{ $value->id }}"><i class="icon-eye-open text-primary"></i>view</a>
                                </td>
                            </tr>
