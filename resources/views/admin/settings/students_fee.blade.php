...
@section('content')
  ...
  <div id="content">
    ...
    <div class="inner">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="admin-save-set-fee" method="post" id="popup-validation">
                    @csrf
                <div class="row">
                   <div class="col-md-3">
                   ...
                   <div class="col-md-3">
                    <select required class="validate[required] form-control chzn-select" name="fees_id" id="fees_id" >
                   ...
                   <div class="col-md-3">
                   <button class="btn btn-primary" type="submit">Set fee</button>
                   </div> 
                </div>
