...
<div class="page-wrapper">
    ...
    <div class="col">
    <h3 class="page-title">Record Students Contributions </h3>
    <ul class="breadcrumb">
    <li class="breadcrumb-item"><a href="home-dashboard">Dashboard</a></li>
    <li class="breadcrumb-item active"> Record Contributions  </li>
    </ul>
    </div>
    </div>
    </div>
...
{{--   
    ...
    <td>
        ...
        <td class="text-end">
        <a href="#" data-bs-toggle="modal" data-bs-target="#edit_teacher{{ $student_contribution->id }}" class="btn btn-sm btn-white text-success me-2"><i class="fas fa-pen me-1"></i> Record Payments</a>
        ...
        <div class="modal custom-modal fade bank-details" id="edit_teacher{{ $student_contribution->id }}" role="dialog">
            ...
            <h4 class="mb-0">Record Contributions Payments </h4>
            </div>
            ...
            <div class="modal-body">
              <form action="msave-school-contributions" method="post">
                @csrf
            
                    <input  type="text" class="form-control" hidden value="{{ $student_contribution->id }}" name="student_contributions_id" id="student_contributions_id">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-md-6">
                        ...
                        <select required  name="methode" id="{{ $student_contribution->id }}" onchange="checkMethod(this.id)" class="form-select form-control">
                         <option value=""></option>
                      ...
                      <div class="col-lg-6 col-md-6" id="Phone{{ $student_contribution->id }}" style="display: none;" >
                        <div class="form-group">
                        <label>Service Provider</label>
                        <select   name="methode_name" id="method_name{{ $student_contribution->id }}"  class="form-select form-control">
                      ...
                      <div class="col-lg-6 col-md-6" id="No{{$student_contribution->id  }}"  style="display: none;">
                        <div class="form-group">
                        <label>Number</label>
                      ...
                      <textarea rows="4" name="description" id="description" type="text" class="form-control" >Option</textarea>
                      </div>
                      </div>
