...
<div class="page-wrapper">
    ...
    <form action="msave-student-results" method="post">
        @csrf
    ...
    <tbody>
      ...
      <tr>
        <td>{{ $index++ }}</td>
        <td>{{ $student->fname }}</td>
        <input type="number" hidden name="year" value="{{ $student->year }}"  step="any" class="form-control">
        <input type="number" hidden name="students_id[]" value="{{ $student->students_id }}"  step="any" class="form-control">
         @foreach ($subjects as $subject)
         <td>

          <input type="number" name="marks{{ $student->students_id }}" placeholder="{{ $subject->subject_name }}"  step="any" class="form-control">
        </td>
