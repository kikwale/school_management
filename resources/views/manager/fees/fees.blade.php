...
<div class="page-wrapper">
    ...
    <div class="col">
    <h3 class="page-title">Register Fees </h3>
    <ul class="breadcrumb">
    <li class="breadcrumb-item"><a href="home-dashboard">Dashboard</a></li>
    <li class="breadcrumb-item active"> Register Fees  </li>
    </ul>
    </div>
    </div>
    </div>
    ...
    <i data-feather="plus-circle"></i> Register New Fee
    </a>
    </div>
    </div>
    </div>
    ...
    <tr>
        ...
        <div class="modal custom-modal fade bank-details" id="edit_teacher{{ $student_fee->id }}" role="dialog">
            ...
            <div class="modal-body">
              <form action="medit-fees" method="post">
                @csrf
        ...
        <div class="modal custom-modal fade" id="delete_paid{{ $student_fee->id }}" role="dialog">
            ...
            <div class="row">
            <div class="col-6">
                <form  method="POST" action="mdelete-fees">
                  @csrf
...
<div class="modal-header">
<div class="form-header text-start mb-0">
<h4 class="mb-0">Register New Fee</h4>
</div>
<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
<span aria-hidden="true">&times;</span>
</button>
...
<div class="modal-body">
  <form action="msave-fees" method="post">
    @csrf
