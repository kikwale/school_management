...
@section('content')
  ...
  <div id="content">
    ...
    <form action="teacher-save-student-results" method="post">
        @csrf
    ...
    <tbody>    
      ...
      <tr>
        <input type="hidden" name="darasas_id" value="{{ $darasa_id }}"  step="any" class="form-control">
        <input type="hidden" name="streams_id" value="{{ $stream_id }}"  step="any" class="form-control">
        ...
        <input type="hidden"  name="students_id[]" value="{{ $student->students_id }}"  step="any" class="form-control">
         ...
         <td>
          ...
          <input required type="number" name="marks{{ $student->students_id }}" placeholder="{{ $subject->name }}"  step="any" class="form-control">
        </td>
