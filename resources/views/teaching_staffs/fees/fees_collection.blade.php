    ...
    <div class="inner">
        ...
        <div class="row">
          ...
          <div class="col-lg-9 col-md-9">
            <form role="form" method="post" action="teacherGetClassFee" enctype="multipart/form-data">
                @csrf
                <div class="col-md-3">
                    <div class="form-group">
                        <label><sup class="text-danger">*</sup>&nbsp;Select Level</label>
                        <select onchange="getClass(this.value)" class=" form-control chzn-select" name="level" id="terms_id">
                            <option value=""></option>
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <label><sup class="text-danger">*</sup>&nbsp;Select Class</label>
                        <select onchange="getClassFee(this.value)" class=" form-control chzn-" name="darasas_id" id="darasas1">
                ...
                <div class="col-md-3">
                <label></label><br>
                 <button type="submit" class="btn btn-primary btn-grad btn-rect" ><i class="icon-search"></i> Filter</button> 
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tr class="odd gradeX">
                               ...
                               <td>{{ $value->fname	 }}</td>
                                ...
                                <td class="center">
                                    <a data-toggle="modal" class="text-success btn" data-target="#fee_payment{{ $value->id }}" href="#"><i class="icon-pencil text-success"></i>Record</a>
                                    &nbsp;<a data-toggle="modal" data-target="#delete{{ $value->id }}" href="#" class="btn"> <i class="icon-edit text-warning"></i>Edit</a> 
                                    &nbsp; <a class="btn" href="teacher-view-fee-payments?id={{ $value->id }}"><i class="icon-eye-open text-primary"></i>view</a>
                                </td>
                            </tr>
                            ...
                            <div class="modal fade" id="fee_payment{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    ...
                                    <form role="form" method="post" action="teacher-save-fee-payment" enctype="multipart/form-data">
                                        @csrf
                            ...
                            <div class="modal fade" id="delete{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                    <form role="form" method="post" action="teacher-edit-fee-payment" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
