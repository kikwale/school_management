    ...
    <div class="inner">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
              ...
              <button class="btn btn-primary btn-grad btn-rect" data-toggle="modal" data-target="#newReg"><i class="icon-plus"></i> New Class Subject</button>
                            ...
                            <tbody>
                                ...
                                <div class="modal fade" id="edit{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        ...
                                        <form role="form" method="post" action="admin-edit-class-subject" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label><sup class="text-danger">*</sup>&nbsp;Subject Name </label>
                                                    <select required class="form-control"  name="subjects_id" id="subjects_id">
                                                        <option value="{{ $value->subjects_id }}">{{ $value->subject_name }}</option>
                                                ...
                                                <div class="form-group">
                                                    <label><sup class="text-danger">*</sup>&nbsp;Subject Status </label>
                                ...
                                <div class="modal fade" id="delete{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                        <form role="form" method="post" action="admin-delete-class-subject" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
    ...
    <div class="modal fade" id="newReg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form role="form" method="post" action="admin-save-class-subject" enctype="multipart/form-data">
                @csrf
            <div class="modal-body">
                <div class="form-group">
                    <label><sup class="text-danger">*</sup>&nbsp;Teacher Name </label>
                ...
                <div class="form-group">
                    <label><sup class="text-danger">*</sup>&nbsp;Subject Name </label>
                    <select required class="form-control" multiple="multiple" size="16" name="subjects_id[]" id="subjects_id">
                        <option value=""></option>
                        @foreach ($subjects as $subject)
                            <option value="{{ $subject->id }}">{{ $subject->name }}</option>
                        @endforeach
