    ...
    <div class="inner">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
              ...
              <button class="btn btn-primary btn-grad btn-rect" data-toggle="modal" data-target="#newReg"><i class="icon-plus"></i> New Subject</button>
                            ...
                            <tbody>
                                ...
                                <div class="modal fade" id="edit{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        ...
                                        <form role="form" method="post" action="admin-edit-subject" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                <label><sup class="text-danger">*</sup>&nbsp;Weight</label>
                                                <input required name="weight" id="weight" value="{{ $value->weight }}" class="form-control" />
                                            </div>
                                           <div class="form-group">
                                ...
                                <div class="modal fade" id="delete{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                        <form role="form" method="post" action="admin-delete-subject" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
    ...
    <div class="modal fade" id="newReg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form role="form" method="post" action="admin-save-subject" enctype="multipart/form-data">
                @csrf
            <div class="modal-body">
                <div class="form-group">
                    <label><sup class="text-danger">*</sup>&nbsp; Name</label>
                ...
                <div class="form-group">
                    <label><sup class="text-danger">*</sup>&nbsp;Weight</label>
                    <input required name="weight" id="weight" class="form-control" />
                </div>
               <div class="form-group">
                    <label>Description</label>
