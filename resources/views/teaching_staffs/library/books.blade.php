    ...
    <div class="inner">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            ...
            <button class="btn btn-primary btn-grad btn-rect" data-toggle="modal" data-target="#newReg"><i class="icon-plus"></i> New Book</button>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label><sup class="text-danger">*</sup>&nbsp; Author</label>
                    <input required name="author" id="author" type="text" class="form-control" />
                </div>
                <div class="form-group">
                    <label><sup class="text-danger"></sup>&nbsp; Volume</label>
                    <input  name="volume" id="volume" type="text" class="form-control" />
                </div>
                <div class="form-group">
                    <label><sup class="text-danger"></sup>&nbsp; Edition</label>
                ...
                <div class="form-group">
                    <label><sup class="text-danger">*</sup>&nbsp; Book Number</label>
                    <input required name="book_number" id="book_number" type="text" class="form-control" />
                </div>
               <div class="form-group">
                    <label><sup class="text-danger"></sup>&nbsp;Location</label>
                    <input  type="text" step="any"  name="location" id="location" class="form-control" />
                </div>
