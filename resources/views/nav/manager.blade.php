<ul class="metismenu" id="menu">
    ...
    <li class="panel active">
        <a href="madmin" style="color:rgb(70, 68, 68)" >
            <i class="icon-user" style="color:rgb(245, 198, 128)"></i> School Admin
    ...
    <li class="panel ">
        ...
        <ul class="collapse" id="staffs">
            ...
            <li class=""><a href="button.html"><i class="icon-minus-sign"></i> Teaching Staffs </a></li>
             <li class=""><a href="icon.html"><i class="icon-minus-sign"></i> Non-Teaching Staffs </a></li>
        </ul>
    </li>
    <li class="panel ">
