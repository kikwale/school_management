<ul class="metismenu" id="menu">
  ...
  <li class="panel ">
      <a href="javascript:void()" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" style="color:rgb(70, 68, 68)" data-target="#staffs">
          <i class="icon-user-md" style="color:rgb(245, 198, 128)"> </i> Administrative
      ...
      <ul class="collapse" id="staffs">
          ...
          <li class=""><a href="admin-teaching-staffs"><i class="icon-minus-sign"></i> Admin </a></li>
          <li class=""><a href="admin-teaching-staffs"><i class="icon-minus-sign"></i> Teaching Staffs </a></li>
           <li class=""><a href="admin-non-teaching-staffs"><i class="icon-minus-sign"></i> Non-Teaching Staffs </a></li>
      </ul>
  </li>
  <li class="panel ">
      ...
      <ul class="collapse" id="create">
          ...
          <li class=""><a href="button.html"><i class="icon-minus-sign"></i> Classes </a></li>
           <li class=""><a href="icon.html"><i class="icon-minus-sign"></i> Section/Stream </a></li>
          <li class=""><a href="progress.html"><i class="icon-minus-sign"></i> Subjects </a></li>
          <li class=""><a href="tabs_panels.html"><i class="icon-minus-sign"></i> Combinations</a></li>
      </ul>
  </li>
  <li class="panel ">
